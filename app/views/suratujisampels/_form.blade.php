{{ Form::open(array('url' => route('surat_uji_sampel.store'), 'method' => 'post', 'id' => 'ujisampels')) }}
	<div class="col-lg-6">
    	<div class="box box-info">
        	...
        	<div class="box-body">
				...
				<div class="form-group">
					{{ Form::label('keterangan', 'Uji Sampel') }}
					<p class="help-block">e.g.:tumbuhan jambu biji</p>
