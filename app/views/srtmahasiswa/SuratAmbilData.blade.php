...
<body>
	...
	<table style="align:center;" width=700px class="Myriad">
		...
		<tr>
			...
			<td width=15%>Hal</td>
			<td width=3% style="text-align:center"> : </td>
			<td width=72%>Permohonan ijin mengambil data</td>
			<td width=10%></td>
		</tr>
	</table>
	<br>
	...
	<table style="align:center;" width=700px class="Myriad">
		...
		<tr>
			...
			<td width=90% style="text-align:justify;">untuk dapatnya mengambil data penelitian di instansi Saudara pada {{$datas->jadwal}}.</td>
			<td width=8%></td>
		</tr>
		<tr><td></td></tr>
		<tr><td></td></tr>
