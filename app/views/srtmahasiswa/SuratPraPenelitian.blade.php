...
<body>
	...
	<table style="align:center;" width=700px class="Myriad">
		...
		<tr>
			...
			<td width=15%>Hal</td>
			<td width=3% style="text-align:center"> : </td>
			<td width=72%>Permohonan ijin pra penelitian</td>
			<td width=10%></td>
		</tr>
	</table>
	<br>
	...
	<table style="align:center;" width=700px class="Myriad">
		<tr>
			<td width=8%></td>
			<td width=90% style="text-align:justify;">Dalam rangka penyusunan skripsi dengan judul "{{$datas->mata_kuliah}}" yang dibimbing oleh {{$datas->pembimbing}} bersama ini kami hadapkan mahasiswa:</td>
			<td width=8%></td>
		</tr>
		<tr><td></td></tr>
		<tr><td></td></tr>
		...
		<tr>
			...
			<td width=90% style="text-align:justify;">untuk dapatnya mengambil data pra penelitian skripsi di instansi Saudara pada {{$datas->jadwal}}.</td>
			<td width=8%></td>
		</tr>
		<tr><td></td></tr>
		<tr><td></td></tr>
