...
<body>
	...
	<table style="align:center;" width=700px class="Myriad">
		...
		<tr>
			...
			<td width=15%>Hal</td>
			<td width=3% style="text-align:center"> : </td>
			<td width=72%>Permohonan ijin kunjungan</td>
			<td width=10%></td>
		</tr>
	</table>
	<br>
	...
	<table style="align:center;" width=700px class="Myriad">
		...
		<tr>
			<td width=8%></td>
			<td width=90%>
				<table class="Myriad" border=1 cellpadding="0" cellspacing="0" width="600px" style="border-collapse:collapse;">
					<thead>
					...
					<tr>
						...
						<td style="padding:5px 5px 5px 10px;">{{$value->mhs_nama}}</td>
						<td style="text-align:center;">{{$value->mhs_nim}}</td>
						<td style="padding:5px 5px 5px 10px;">{{$value->Prodi->prodi}}</td>
						<?php $no++; ?>
					</tr>
					@endforeach
				</table>
		...
		<tr>
			...
			<td width=90% style="text-align:justify;">untuk dapatnya melakukan kunjungan di instansi saudara pada {{$datas->jadwal}}.</td>
			<td width=8%></td>
		</tr>
		<tr><td></td></tr>
		<tr><td></td></tr>
