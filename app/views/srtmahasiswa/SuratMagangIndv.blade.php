...
<head>
	...
	<title>Surat Ijin Penempatan Magang</title>
</head>
<body>
	...
	<table style="align:center;" width=700px class="Myriad">
		<tr>
			<td width=8%></td>
			<td width=90% style="text-align:justify;">Bersama ini kami mengajukan permohonan dapatnya mahasiswa dari FMIPA Universitas Negeri Surabaya melaksanakan magang di instansi Saudara.</td>
			<td width=8%></td>
		</tr>
		<tr><td></td></tr>
		<tr><td></td></tr>
		...
		<tr>
			<td width=8%></td>
			<td width=90% style="text-align:justify;">Direncanakan pelaksanaan magang pada bulan {{$datas->jadwal}}. Adapun yang akan melaksanakan magang mahasiswa Program Studi <b>{{$datas->Dataprodi->prodi}}</b></td>
			<td width=8%></td>
		</tr>
		<tr><td></td></tr>
		<tr><td></td></tr>
			...
			<td width=90%>
				<table class="Myriad" cellpadding="0" cellspacing="0" width="600px" style="border-collapse:collapse;">
					<tr style="font-weight: bold;">
						...
						<td style="padding:1px 1px 5px 10px; width:45%">{{$datas->nama}}</td>
						<td style="text-align:center; width:20%">NIM</td>
						<td style="text-align:center; width:25%">{{$datas->nim}}</td>
					</tr>
				</table>
			</td>
			<td width=8%></td>
		...
		<tr>
			...
			<td width=90% style="text-align:justify;">Hal-hal lain yang berhubungan dengan pelaksanaan magang di tempat, kami serahkan kepada kebijaksanaan Saudara.</td>
			<td width=8%></td>
		</tr>
	</table>
	<br>
