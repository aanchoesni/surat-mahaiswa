{{ Form::open(array('url' => route('surat_membeli_bahan.store'), 'method' => 'post', 'id' => 'membelibahans')) }}
	<div class="col-lg-6">
    	<div class="box box-info">
        	...
        	<div class="box-body">
				...
				<div class="form-group">
					...
					<p class="help-block">e.g.: 1. penyusunan skripsi dengan judul "Judul Skripsi"</p>
					<p class="help-block">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. memenuhi tugas mata kuliah Taksonomi Avertebrata</p>
					{{ Form::text('mata_kuliah', null, array('class' => 'form-control','placeholder'=>'Masukkan Dalam Rangka')) }}
				</div>
				<div class="form-group">
					{{ Form::label('keterangan', 'Bahan Kimia dan satuan') }}
					<p class="help-block">e.g.:toluene 1L</p>
