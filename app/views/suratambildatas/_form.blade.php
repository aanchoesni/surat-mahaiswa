{{ Form::open(array('url' => route('surat_ambil_data.store'), 'method' => 'post', 'id' => 'ambildatas')) }}
	<div class="col-lg-6">
    	<div class="box box-info">
        	...
        	<div class="box-body">
				...
				<div class="form-group">
					...
					<p class="help-block">e.g.: kosongi apabila tidak ada lampiran</p>
				...
				<div class="form-group">
					{{ Form::label('mata_kuliah', 'Judul Skripsi') }}
					{{ Form::text('mata_kuliah', null, array('class' => 'form-control','placeholder'=>'Masukkan Judul Skripsi')) }}
				</div>
				{{-- <div class="form-group">
					{{ Form::label('keterangan', 'Tujuan Penelitian') }}
					<p class="help-block">e.g.:menyebar angket penelitian skripsi</p>
